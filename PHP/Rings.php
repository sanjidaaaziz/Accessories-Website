...
<html lang="en">
  ...
  <section class="ring" id="ring">
    <div class="content">
      <h3>Rings <span>Collection</span></h3>
      <p>
        Get your desired ring!
      </p>
  ...
  <section class="individual" id="individual">
    <h1 class="heading">our<span>rings</span></h1>

    <div class="box-container">
      <div class="box">
        <img src="ring1.jpg" alt="" />
        <h3>gothic ring set</h3>
        <p>৳ 160</p>
        <a href="#" class="btn">add to cart</a>
      </div>

      <div class="box">
        <img src="ring2.jpg" alt="" />
        <h3>hollow round silver ring set</h3>
        <p>৳ 170</p> 
        <a href="#" class="btn">add to cart</a>
      </div>

      <div class="box">
        <img src="ring3.jpg" alt="" />
        <h3>adjustable golden rings</h3>
        <p>৳ 220</p>
        <a href="#" class="btn">add to cart</a>
      </div>
  ...
  <section class="individual" id="individual">
    <div class="box-container">
      <div class="box">
        ...
        <h3>minimul ring set</h3>
        <p>৳ 250</p>
        <a href="#" class="btn">add to cart</a>
      </div>

      <div class="box">
        <img src="ring6.jpg" alt="" />
        <h3>adjustable silver rings</h3>
        <p>৳ 220</p>
        <a href="#" class="btn">add to cart</a>
      </div>

      <div class="box">
        <img src="ring7.jpg" alt="" />
        <h3>retro ring set</h3>
        <p>৳ 250</p>
        <a href="#" class="btn">add to cart</a>
      </div>
      
      <div class="box">
        <img src="ring8.jpg" alt="" />
        <h3>gold plated ring set</h3>
        <p>৳ 250</p>
        <a href="#" class="btn">add to cart</a>
      </div>
    </div>
