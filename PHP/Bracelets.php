...
<html lang="en">
  ...
  <!--header section ends-->
  <!--home section starts-->
  <section class="brac" id="brac">
    <div class="content">
      <h3>Bracelet <span>Collection</span></h3>
      <p>
        Don't miss these elegant Bracelets!
      </p>
  ...
  <section class="individual" id="individual">
    <h1 class="heading">our<span>Bracelets</span></h1>

    <div class="box-container">
      <div class="box">
        <img src="brac1.jpg" alt="" />
        <h3>geometric Bracelet set</h3>
        <p>৳ 250</p>
        <a href="#" class="btn">add to cart</a>
      </div>

      <div class="box">
        <img src="brac2.jpg" alt="" />
        <h3>golden heart Bracelet</h3>
        <p>৳ 170</p> 
        <a href="#" class="btn">add to cart</a>
      </div>

      <div class="box">
        <img src="brac3.jpg" alt="" />
        <h3>arrow leaf circle Bracelet</h3>
        <p>৳ 250</p>
        <a href="#" class="btn">add to cart</a>
      </div>
      
      <div class="box">
        <img src="brac4.jpg" alt="" />
        <h3>silver heart Bracelet</h3>
        <p>৳ 170</p>
        <a href="#" class="btn">add to cart</a>
      </div>
    </div>
  ...
  <section class="individual" id="individual">
    <div class="box-container">
      <div class="box">
        <img src="brac5.jpg" alt="" />
        <h3>multilayer butterfyl Bracelet set</h3>
        <p>৳ 230</p>
        <a href="#" class="btn">add to cart</a>
      </div>

      <div class="box">
        <img src="brac6.jpg" alt="" />
        <h3>Astronaut bff Bracelet-black</h3>
        <p>৳ 150</p>
        <a href="#" class="btn">add to cart</a>
      </div>

      <div class="box">
        <img src="brac7.jpg" alt="" />
        <h3>Astronaut bff Bracelet-gray</h3>
        <p>৳ 150</p>
        <a href="#" class="btn">add to cart</a>
      </div>
      
      <div class="box">
        <img src="brac8.jpg" alt="" />
        <h3>Premium Bracelet set</h3>
        <p>৳ 250</p>
        <a href="#" class="btn">add to cart</a>
      </div>
    </div>
