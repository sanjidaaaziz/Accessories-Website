...
<html lang="en">
  ...
  <body>
    ...
    <section class="acc" id="acc">
      <div class="content">
        <h3>premium<span> accessories</span></h3>
        <p>
          We offer premium quality women accessories with love and authenticity.
          Products are imported from different countries. we assure colour
          guarantee!
        </p>
    ...
    <!--<section class="payment" id="payment">
      ...
      <div class="box-container">
        <div class="box">
          <img src="bkash.jpg" alt="" />
          <h3>Bkash</h3><p>01784533104</p>
        </div>
  
        <div class="box">
          <img src="nagad.png" alt="" />
          <h3>Nagad</h3><p>01622084621</p>
        </div>
  
        <div class="box">
          <img src="rocket.jpg" alt="" />
          <h3>Rocket</h3><p>01622084621</p>
        </div>
