...
<html lang="en">
  ...
  <section class="neck" id="neck">
    <div class="content">
      <h3>Neckpiece<span> Collection</span></h3>
      <p>
        Check our finely designed neckpieces!
      </p>
  ...
  <section class="individual" id="individual">
    <h1 class="heading">our<span>neckpieces</span></h1>

    <div class="box-container">
      <div class="box">
        <img src="neck1.jpg" alt="" />
        <h3>asymmetric pendant</h3>
        <p>৳ 350</p>
        <a href="#" class="btn">add to cart</a>
      </div>

      <div class="box">
        <img src="neck2.jpg" alt="" />
        <h3>three tier coin chain</h3>
        <p>৳ 390</p>
        <a href="#" class="btn">add to cart</a>
      </div>

      <div class="box">
        <img src="neck3.jpg" alt="" />
        <h3>minimulist multilayer</h3>
        <p>৳ 380</p>
        <a href="#" class="btn">add to cart</a>
      </div>
      
      <div class="box">
        <img src="neck4.jpg" alt="" />
        <h3>cielo pendant</h3>
        <p>৳ 130</p>
        <a href="#" class="btn">add to cart</a>
      </div>
  ...
  <section class="individual" id="individual">
    <div class="box-container">
      <div class="box">
        <img src="neck5.jpg" alt="" />
        <h3>joie multilayer</h3>
        <p>৳ 400</p>
        <a href="#" class="btn">add to cart</a>
      </div>

      <div class="box">
        <img src="neck6.jpg" alt="" />
        <h3>metallic layered necklace</h3>
        <p>৳ 260</p>
        <a href="#" class="btn">add to cart</a>
      </div>

      <div class="box">
        <img src="neck7.jpg" alt="" />
        <h3>single Gold plated pendant</h3>
        <p>৳ 130</p>
        <a href="#" class="btn">add to cart</a>
      </div>
      
      <div class="box">
        <img src="neck8.jpg" alt="" />
        <h3>deer horn pendant</h3>
        <p>৳ 150</p>
        <a href="#" class="btn">add to cart</a>
      </div>
    </div>
