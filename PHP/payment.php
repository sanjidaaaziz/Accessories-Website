...
<html lang="en">
  ...
  <!--header section ends-->
    <section class="start" id="start">
      <div class="content">
        <h3>easy<span> Payments</span></h3>
        <p>
          We provide both online payment and cash on delivery. The online
          payment can be done though bkash, nagad and rocket by using send money
          option!
        </p>
